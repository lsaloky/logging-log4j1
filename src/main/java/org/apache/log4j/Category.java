...
public class Category implements AppenderAttachable {
  ...
  public Priority getChainedPriority() { return null; }

  public static Enumeration getCurrentCategories() { return null; }

  public static LoggerRepository getDefaultHierarchy() { return null; }

  public LoggerRepository  getHierarchy() { return null; }
  
  public LoggerRepository  getLoggerRepository() { return null; }

  public static Category getInstance(String name) { return null; }

  public static Category getInstance(Class clazz) { return null; }

  public final String getName() { return ""; }

  final public Category getParent() { return null; }

  final public Level getLevel() { return null; }

  final public Level getPriority() { return null; }

  final public static Category getRoot() { return null; }

  public ResourceBundle getResourceBundle() {return null; }

  protected String getResourceBundleString(String key) { return ""; }
